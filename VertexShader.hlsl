...
// TODO: Part 4g
// TODO: Part 2i -- create structured buffer
...
// TODO: Part 1f 
// TODO: Part 4a -- Adjust vertex shader to take in Position, UV, and Normal, and tweak output in main()
struct V_IN
{
...
// TODO: Part 4b -- adjust output so it outputs V_OUT struct
struct V_OUT
{
...
V_OUT main(V_IN inputVertex)
{
    V_OUT output = (V_OUT) 0;
		...
		// TODO: Part 1h -- temporarily adjust values to see the model on the screen
    //inputVertex.localPos.y -= .75f;
    //inputVertex.localPos.z += .75f;
	//output.projectedPos = inputVertex.localPos;

		// TODO: Part 2i -- multiply stuff // TODO: Part 4e -- set matrices to meshID
    output.projectedPos = mul(float4(inputVertex.localPos, 1), SceneData[0].matricies[meshID]);
	...
	output.tex		    = inputVertex.tex;
		...
		// TODO: Part 4b -- Get normal into world space
	output.norm			= mul(float4(inputVertex.norm, 0), SceneData[0].matricies[meshID]).xyz;		// output normal = inputNorm * world (putting it into world space)
